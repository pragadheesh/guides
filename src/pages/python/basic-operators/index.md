...
<br>
<b>a = 18</b> Here <i>=</i> is an assignment operator, and the result is stored in the variable a
<br>
<b>a += 10</b> Here <i>+=</i> is an assignment operator, and the result is stored in variable a. This is same as a = a + 10.
